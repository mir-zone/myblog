...
**More Gallery Goodness:** A few more examples and [source code](https://github.com/{{ site.repository }}\study-archive/2010-09-09-post-gallery.md) can be seen in [this sample gallery post]({% post_url 2010-09-09-post-gallery %}).
{: .notice--info}
